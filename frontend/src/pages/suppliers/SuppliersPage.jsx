  ...
  return (
    <div className="page-container">
      <div className="page-header">
        <div className="min-w-0"><h1 className="text-xl sm:text-2xl font-bold break-words">Suppliers</h1><p className="text-sm text-gray-500 mt-1">{total} total suppliers</p></div>
        <button onClick={() => { setEditSupplier(null); setShowModal(true); }} className="btn-primary p-2 sm:px-4 flex items-center gap-1.5 sm:gap-2 flex-shrink-0"><FiPlus className="w-4 h-4" /><span className="hidden sm:inline">Add Supplier</span></button>
      </div>
